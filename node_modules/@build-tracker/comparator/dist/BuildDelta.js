        ...
        get: function () {
            ...
            if (!this._artifactDeltas) {
                ...
                this.artifactNames.forEach(function (artifactName) {
                    ...
                    var delta = new ArtifactDelta_1.default(artifactName, _this._artifactBudgets[artifactName] || [], sizes, prevSizes, !baseArtifact || !prevArtifact || baseArtifact.hash !== prevArtifact.hash);
        ...
        get: function () {
            ...
            if (!this._groupDeltas) {
                ...
                this._groups.forEach(function (group) {
                    var artifactNames = group.artifactNames ? group.artifactNames.slice() : [];
